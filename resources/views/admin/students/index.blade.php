<x-layouts.admin>
    ...
    <div class="flex flex-wrap justify-between mb-4">
        <div class="mb-4 md:mb-0">
            <h1 class="text-xl sm:text-2xl font-bold">Siswa</h1>
            <p class="text-sm font-normal opacity-60">Daftar siswa</p>
        </div>
                    ...
                    <td>
                        <div class="flex gap-1">
                            <div class="tooltip" data-tip="Edit">
                                <a href="{{ route('admin.students.edit', $student) }}" class="btn btn-outline btn-sm rounded-sm">
                                    <svg class="w-[18px] h-[18px]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <form method="POST" action="{{ route('admin.students.destroy', $student) }}" onsubmit="return confirm('Yakin hapus?')">
                                @csrf
                                @method('DELETE')
